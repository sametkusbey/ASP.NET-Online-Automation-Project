...
namespace OnlineAutomationProject.Controllers
{
    public class İstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d8 = deger8;
            // ürün içerisindeki satisfiyatı sırala ve urun ad ı seç 
            var deger9 = (from x in c.Uruns orderby x.SatisFiyat ascending select x.UrunAd).FirstOrDefault();
            ViewBag.d9 = deger9;

            var deger10 = c.Uruns.Count(x => x.UrunAd == "Süzgeç").ToString();  
            ViewBag.d10 = deger10;


            var deger11 = c.Uruns.Count(x => x.kategoriid == 27).ToString();  
            ViewBag.d11 = deger11;
